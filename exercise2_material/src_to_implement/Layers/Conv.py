...
class Conv:
    ...
    #                     self.gradient_weights[k, c] += scipy.signal.convolve(padded_input, error_tensor[b, k], mode='valid')
    #                     gradient_input[b, c] += scipy.signal.correlate(error_tensor[b, k], self.weights[k, c], mode='full')[pad[0]:-pad[1] or None]
